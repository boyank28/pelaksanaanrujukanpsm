...
INSERT INTO amprahan_approval VALUES("7","2026","dicek","admin","Administrator","2026-07-10 22:46:21");
INSERT INTO amprahan_approval VALUES("7","2026","mengetahui","admin","Administrator","2026-07-10 22:46:19");
INSERT INTO amprahan_approval VALUES("7","2026","menyetujui","admin","Administrator","2026-07-10 22:46:23");
...
INSERT INTO bukti_pelaksanaan_rujukan_psm VALUES("2026/07/07/000198","2026-07-10","pages/upload/2026070700019820260710164313.jpeg");
...
INSERT INTO bukti_pelaksanaan_rujukan_psm VALUES("2026/07/09/000253","2026-07-10","pages/upload/2026070900025320260710162420.jpeg");
INSERT INTO bukti_pelaksanaan_rujukan_psm VALUES("2026/07/09/000261","2026-07-10","pages/upload/2026070900026120260710160432.jpeg");
...
INSERT INTO bukti_pelaksanaan_rujukan_psm VALUES("2026/07/09/000277","2026-07-10","pages/upload/2026070900027720260710174529.jpeg");
INSERT INTO bukti_pelaksanaan_rujukan_psm VALUES("2026/07/10/000072","2026-07-10","pages/upload/2026071000007220260710155809.jpeg");
...
INSERT INTO log_aktivitas VALUES("66","2026-07-10 20:17:42","admin","127.0.0.1","Melakukan Backup Database");
INSERT INTO log_aktivitas VALUES("67","2026-07-10 20:20:50","admin","127.0.0.1","Membatalkan validasi (mengetahui) laporan Amprahan bulan 7 tahun 2026");
INSERT INTO log_aktivitas VALUES("68","2026-07-10 20:20:51","admin","127.0.0.1","Membatalkan validasi (dicek) laporan Amprahan bulan 7 tahun 2026");
INSERT INTO log_aktivitas VALUES("69","2026-07-10 20:20:52","admin","127.0.0.1","Membatalkan validasi (menyetujui) laporan Amprahan bulan 7 tahun 2026");
INSERT INTO log_aktivitas VALUES("70","2026-07-10 20:25:42","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("71","2026-07-10 20:25:55","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("72","2026-07-10 20:36:42","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("73","2026-07-10 20:37:11","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("74","2026-07-10 21:37:02","admin","127.0.0.1","Logout dari sistem");
INSERT INTO log_aktivitas VALUES("75","2026-07-10 21:37:36","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("76","2026-07-10 21:43:21","admin","127.0.0.1","Menyimpan foto bukti dan rujukan PSM dengan no rawat 2026/07/07/000198 (ID PSM: 6)");
INSERT INTO log_aktivitas VALUES("77","2026-07-10 22:18:53","admin","127.0.0.1","Logout dari sistem");
INSERT INTO log_aktivitas VALUES("78","2026-07-10 22:19:01","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("79","2026-07-10 22:19:16","admin","127.0.0.1","Melakukan Backup Database");
INSERT INTO log_aktivitas VALUES("80","2026-07-10 22:19:24","admin","127.0.0.1","Menghapus data rujukan PSM dengan no rawat 2026/07/07/000198");
INSERT INTO log_aktivitas VALUES("81","2026-07-10 22:19:29","admin","127.0.0.1","Menghapus data rujukan PSM dengan no rawat 2026/07/09/000253");
INSERT INTO log_aktivitas VALUES("82","2026-07-10 22:19:49","admin","127.0.0.1","Logout dari sistem");
INSERT INTO log_aktivitas VALUES("83","2026-07-10 22:24:44","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("84","2026-07-10 22:24:53","admin","127.0.0.1","Logout dari sistem");
INSERT INTO log_aktivitas VALUES("85","2026-07-10 22:29:46","admin","127.0.0.1","Login ke dalam sistem");
INSERT INTO log_aktivitas VALUES("86","2026-07-10 22:45:36","admin","127.0.0.1","Menyimpan foto bukti dan rujukan PSM dengan no rawat 2026/07/09/000277 (ID PSM: 5)");
INSERT INTO log_aktivitas VALUES("87","2026-07-10 22:46:19","admin","127.0.0.1","Melakukan validasi (mengetahui) laporan Amprahan bulan 7 tahun 2026");
INSERT INTO log_aktivitas VALUES("88","2026-07-10 22:46:21","admin","127.0.0.1","Melakukan validasi (dicek) laporan Amprahan bulan 7 tahun 2026");
INSERT INTO log_aktivitas VALUES("89","2026-07-10 22:46:23","admin","127.0.0.1","Melakukan validasi (menyetujui) laporan Amprahan bulan 7 tahun 2026");
...
INSERT INTO pelaksanaan_rujukan_psm VALUES("2026/07/09/000277","2026-07-10 17:45:29","5","admin","Pasien","-");
...
CREATE TABLE `setting_fee_psm` (
  ...
  `fee_ralan_op` double DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO setting_fee_psm VALUES("1","75000","50000","25000","125000");
...
INSERT INTO setting_ttd_amprahan VALUES("1","Rhofiah.Amd","Pjs Kabag Marketing","Wulan Ria Fatmawati","Ka.Unit Akutansi & Keuangan","dr. Evameinonda., MMRS.MQM.FISQua","Direktur","Fitri Maria Agustina","Staf Marketing");
...
INSERT INTO users VALUES("1","admin","$2y$10$7EP1.9spPNKFTEud1bNU7OITc1yOg1cWFx4rUyEaTYS0XcEmaVp0m","Admin","Administrator","superadmin","{\"can_manage_rujukan\":true,\"can_view_laporan\":true,\"can_manage_fee\":true,\"can_manage_users\":true,\"can_backup\":true,\"can_view_log\":true,\"can_approve_mengetahui\":true,\"can_approve_dicek\":true,\"can_approve_menyetujui\":true}","Aktif");
